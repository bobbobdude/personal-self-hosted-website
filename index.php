...
<body>
    ...
    <div class="pictures_container">
        <figure>
            <img src="images/tom-serious-with-rpi.jpg"
                alt="A ginger man with a serious demeanour pointing to a Raspberry Pi mounted on a pegboard"
                class="pictures">
            <figcaption>
                Fig.1 - Me taking a serious picture pointing to my serious server that you are seriously connected to
            </figcaption>
        </figure>
        <figure>
            <img src="images/tom-smiling-with-rpi.jpg"
                alt="A ginger man smiling while pointing to a Raspberry Pi mounted on a pegboard" class="pictures">
            <figcaption>
